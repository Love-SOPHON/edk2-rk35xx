[Defines]
  ...
  FLASH_DEFINITION               = custRkPkg/Devices/SoC/rk3588.fdf
  BOARD_DXE_FV_COMPONENTS        = custRkPkg/Devices/3588test.fdf.inc

!include custRkPkg/Devices/SoC/rk3588.dsc

[BuildOptions.common]
  GCC:*_*_AARCH64_CC_FLAGS = -DENABLE_SIMPLE_INIT -DRK3588 -Wno-error=unused-function
...
[PcdsFixedAtBuild.common]
  ...
  # Device Information
  gcustRkPkgTokenSpaceGuid.PcdDeviceVendor|"Whatever"
  gcustRkPkgTokenSpaceGuid.PcdDeviceProduct|"RK3588 SBC"
  gcustRkPkgTokenSpaceGuid.PcdDeviceCodeName|"3588test"
  gcustRkPkgTokenSpaceGuid.PcdPlatformName|"Whatever RK3588 SBC"
  gcustRkPkgTokenSpaceGuid.PcdCpuName|"Rockchip RK3588 (Cortex-A55 + Cortex-A76)"
...
[Components.common]
  ...
  # Board specific
  #
  custRkPkg/Drivers/BoardInitDxe3588test/BoardInitDxe.inf
